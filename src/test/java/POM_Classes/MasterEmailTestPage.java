...
public class MasterEmailTestPage extends Base_Page {
    WebDriver driver;
    WebDriverWait wait;
    ...
    public MasterEmailTestPage(WebDriver driver) {
        this.driver = driver;
    ...
    public void readEmail(String subject) throws InterruptedException {
        ...
        WebElement email = wait.until(ExpectedConditions.presenceOfElementLocated(
            By.xpath("//p[normalize-space()='Master Franchisee Registration Application Approved']")));
        System.out.println("Subject : Master Franchisee Registration Application Approved");
    ...
    public String readEmailandgetbody(String emailSubject) {
        ...
        while (attempts < 3) {
            try {
            	 WebElement email = wait.until(ExpectedConditions.presenceOfElementLocated(
            	            By.xpath("//p[normalize-space()='Master Franchisee Registration Details-ReachMyIndia']")));
            	        email.click();
